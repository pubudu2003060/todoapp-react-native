...
import { View, StyleSheet, ScrollView, StatusBar, BackHandler, Text } from 'react-native'; // Removed TextInput, TouchableOpacity, Image
...
function Home() {
    ...
    const sortedTaskList = useMemo(() => {
        ...
        switch (sortOption) {
            case 'priorityAsc':
                sortedList.sort((a, b) => priorityValue(a.priority) - priorityValue(b.priority));
                break;
            case 'priorityDesc':
                sortedList.sort((a, b) => priorityValue(b.priority) - priorityValue(a.priority));
                break;
            case 'dateAsc':
